...
prediction1 = tk.Button(text='-', width = 20, height=3,activeforeground = '#e6e6e6',activebackground = '#333333', relief='raised')
prediction1.grid(row = 0, column = 0)
prediction1['font'] = myFont
prediction1.bind('<Button-1>', handle_click)

prediction2 = tk.Button(text='-',width = 20, height=3,activeforeground = '#e6e6e6',activebackground = '#333333', relief='raised')
prediction2.grid(row = 0, column = 1)
prediction2['font'] = myFont
prediction2.bind('<Button-1>', handle_click)

prediction3 = tk.Button(text='-',width = 20, height=3,activeforeground = '#e6e6e6',activebackground = '#333333', relief='raised')
prediction3.grid(row = 0, column = 2)
